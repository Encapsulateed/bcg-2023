...
namespace bcg_bot.Types
{
    public static class Messages
    {
        public static readonly Dictionary<string, string> messages = new Dictionary<string, string>()
        {
            ...
            { "SELECT_COMAND","Выбери команду"},
            {"ASK_COMAND_TITLE","Введи название своей команды" },
            {"WAIT_FOR_CAPITAINE_RESPONSE","Ваша заявка направелена капитану команды, пожалуйста, подождите его ответа"},
            {"TO_MANY_PARTICIPANTS","К сожалению, в этой команде, уже слишком много участников, пожалуйста выбери другую"},
            { "REPETED_REGISTRATION","Повторная регистрация запрещена!"}
        };
    }
}